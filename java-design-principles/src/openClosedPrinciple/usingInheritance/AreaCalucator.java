...
//	public double calculateCircleArea(Circle circle) {
	...
	//}
	//we can create generic method for all shapes
	
	//even if a new shape comes it will be forced to have area calcuation logic
	public double calculateAreaOfShape(Shape shape) {
